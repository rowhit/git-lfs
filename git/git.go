...
// Invoke Git with disabled LFS filters
func simpleGitNoLFS(args ...string) (string, error) {
...
func simpleGit(args ...string) (string, error) {
...
func LsRemote(remote, remoteRef string) (string, error) {
	...
	if remoteRef == "" {
		return simpleGitNoLFS("ls-remote", remote)

	}
	return simpleGitNoLFS("ls-remote", remote, remoteRef)
}

func ResolveRef(ref string) (*Ref, error) {
	outp, err := simpleGitNoLFS("rev-parse", ref, "--symbolic-full-name", ref)
	if err != nil {
...
func (c *gitConfig) SetSystem(key, val string) (string, error) {
	return simpleGit("config", "--system", key, val)
}
...
func (c *gitConfig) UnsetGlobal(key string) (string, error) {
	return simpleGit("config", "--global", "--unset", key)
}
...
func (c *gitConfig) UnsetSystem(key string) (string, error) {
	return simpleGit("config", "--system", "--unset", key)
}
...
func (c *gitConfig) UnsetGlobalSection(key string) (string, error) {
	return simpleGit("config", "--global", "--remove-section", key)
}
...
func (c *gitConfig) UnsetSystemSection(key string) (string, error) {
	return simpleGit("config", "--system", "--remove-section", key)
}
...
func (c *gitConfig) UnsetLocalSection(key string) (string, error) {
	return simpleGit("config", "--local", "--remove-section", key)
}
